...
<<<<<<< HEAD
\chead{Table of Contents} % Set the left side page header to "Contents"
=======
% Set the left side page header to "Contents"
>>>>>>> 6b4d53607584766c292ab36c0e0d7e9d5635cf05
\tableofcontents % Write out the Table of Contents

\vspace{1em}
\chead{List of Figures} % Set the left side page header to "List of Figures"
