...
\begin{figure}[htbp]
	\centering
		...
		\rule{35em}{0.5pt}
	\caption[Large Setpoints 3D Path]{Testing the control with larger set points - the 3D path}
...
\begin{figure}[htbp]
	\centering
		...
		\rule{35em}{0.5pt}
	\caption[Large Setpoint Time Domain]{Testing the control with larger set points - time domain plots }
