...
zdd = (k/m)*(w1**2 + w2**2 + w3**2 + w4**2)*n.cos(Phi)*n.cos(Theta)-g
...
(k/m)*(w1**2 + w2**2 + w3**2 + w4**2)*n.cos(Phi)*n.cos(Theta) - g - zdd,
...
( (k/m)*(w1**2 + w2**2 + w3**2 + w4**2)*n.cos(Phi)*n.cos(Theta) - g - zdd )**2,
...
def dw1(w1,w2,w3,w4):
    ...
    2* ( (k/m)*(w1**2 + w2**2 + w3**2 + w4**2)*n.cos(Phi)*n.cos(Theta) -g - zdd ) * (k/m) * 2*w1  * n.cos(Phi) * n.cos(Theta),
...
def dw2(w1,w2,w3,w4): 
    ...
    2* ( (k/m)*(w1**2 + w2**2 + w3**2 + w4**2)*n.cos(Phi)*n.cos(Theta) - g - zdd ) * (k/m) * 2*w2  * n.cos(Phi) * n.cos(Theta),
...
def dw3(w1,w2,w3,w4):
    ...
    2* ( (k/m)*(w1**2 + w2**2 + w3**2 + w4**2)*n.cos(Phi)*n.cos(Theta) - g - zdd ) * (k/m) * 2*w3  * n.cos(Phi) * n.cos(Theta),
...
def dw4(w1,w2,w3,w4):
    ...
    2* ( (k/m)*(w1**2 + w2**2 + w3**2 + w4**2)*n.cos(Phi)*n.cos(Theta) - g - zdd ) * (k/m) * 2*w4  * n.cos(Phi) * n.cos(Theta),
