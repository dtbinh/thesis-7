...
h = 0.01
max_timesteps = 1000 #this is the number of iterations in the time series, 

go(0,0,0,h,max_timesteps)
...
call:    solution = solve_for_motor_speeds( Theta,Phi,Psi, xdd,ydd,zdd, psidd,thedd,phidd, w1p,w2p,w3p,w4p  )
